...
parser.add_argument('--result_path', type=str, default='result', help='name of the folder to save results in')
...
parser.add_argument('--image_width', type=int, default=768, help='output image width')
